...
> Figures are committed under `figures/` and are regenerated by
...
![Revenue and profit trend as small multiples](figures/trend_light.png)

**2 — Sales by state (sequential choropleth; the Profit metric switches it to diverging)**

![Choropleth of profit by state](figures/map_light.png)

**3 — Correlation matrix**

![Correlation matrix of the numeric columns](figures/correlation_light.png)

**4 — Profit distribution by category (box plot)**

![Box plot of profit distribution by category](figures/distribution_light.png)

**5 — Category → sub-category sunburst**

![Sunburst of category and sub-category sales](figures/sunburst_light.png)

**6 — Year-over-year animation (fixed y-axis across frames)**

![Animated year-over-year comparison](figures/animated_light.png)

**7 — Discount versus profit, with a 95% confidence band**

![Scatter of discount against profit with regression line](figures/scatter_light.png)

**8 — Segment by category (stacked bar)**

![Stacked bar of segment by category](figures/stacked_light.png)
